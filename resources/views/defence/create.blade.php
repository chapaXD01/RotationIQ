                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="rotation-name" placeholder="Enter rotation name" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                        <div class="mb-6">
                            <label for="rotationType" class="block text-sm font-medium mb-2">{{ __('Rotation Type') }}</label>
                            <select id="rotationType" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500">
                        ...
                        <div class="space-y-2">
                            ...
                            <button onclick="saveRotation()" class="w-full px-4 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition">
                                {{ __('Save Rotation') }}
                            </button>
