                        ...
                        <div class="flex flex-col lg:flex-row gap-8 items-start justify-center">
                            ...
                            <div class="rounded-lg p-6" style="background-color: rgba(59, 130, 246, 0.15); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                                ...
                                <div class="mt-6 pt-6 border-t border-gray-400">
                                    ...
                                    <input type="text" id="movement-name" placeholder="Enter movement name" class="w-full px-4 py-2 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-300 transition" style="background-color: rgba(30, 41, 59, 0.6); border: 1px solid rgba(255, 255, 255, 0.2); color: white;">
                                    
                                    <button onclick="saveNewMovement()" class="w-full mt-3 px-6 py-3 text-white font-semibold rounded-lg transition" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.9) 0%, rgba(37, 99, 235, 0.9) 100%); border: 1px solid rgba(255, 255, 255, 0.3);">
                                        Save Movement
                                    </button>
                                </div>
                            </div>
